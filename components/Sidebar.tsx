...
export default function Sidebar() {
	return (
		<aside className='fixed top-0 left-0 h-full pt-[72px] flex'>
			...
			<div className='bg-white border-r border-[#EAECF0] w-[282px] py-10 px-2 flex flex-col gap-4 items-start'>
					...
					<AccordionItem
						...
						<AccordionContent className='flex flex-col items-start text-sm'>
							<ul className='w-full space-y-2 text-xs'>
								<li className='flex items-center justify-between w-full hover:bg-gray-100 px-4 py-2 rounded-lg'>
									Overview
